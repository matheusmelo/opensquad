  ...
  "inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-zinc-300 focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        working: "border-emerald-500/50 bg-emerald-950/50 text-emerald-400 animate-pulse",
        idle: "border-zinc-700 bg-zinc-900 text-zinc-500",
        done: "border-blue-500/50 bg-blue-950/50 text-blue-400",
        failed: "border-red-500/50 bg-red-950/50 text-red-400",
      },
    },
